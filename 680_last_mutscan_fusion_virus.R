...
#mutscan
file_html <- paste0(path,"MutScan/0001.MutScan_out_html_output_5.html.files/main.html")
...
###cnv
cnv_dir <- paste0(path,"cnv/")
cnv_txt <- paste0(cnv_dir,sample,"_rg_cnv.genes188in680_gain.csv")
cnv_df <- read.csv(cnv_txt, header=TRUE, fileEncoding = "utf-8",na = "")
out_cnv <- paste0(out_dir,sample,"_cnv_result.csv")
write.table(cnv_df,file=out_cnv,row.names=FALSE, na="", quote = F,sep=",")
